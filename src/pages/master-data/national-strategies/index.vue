<template lang="">
  <div>
    <div class="d-flex justify-end mb-6">
      <VBtn
        color="primary"
        @click="$router.push('/master-data/national-strategies/create')"
      >
        {{ $t("common.btn.create") }}
      </VBtn>
    </div>
        ...
        <template #item.actions="{ item }">
          <div class="d-flex justify-space-between">
            <VIcon
              ...
              class="details_icon"
              @click="
                $router.push(`/master-data/national-strategies/${item.id}`)
              "
            />
            <VIcon
              :icon="'tabler-edit'"
              ...
              class="edit_icon"
              @click="
                $router.push(`/master-data/national-strategies/${item.id}/edit`)
              "
            />
