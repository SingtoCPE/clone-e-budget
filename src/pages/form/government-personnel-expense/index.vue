<template lang="">
  <div>
    <div class="d-flex justify-end mb-6">
      <VBtn
        color="primary"
        @click="$router.push('/form/government-personnel-expense/create')"
      >
        {{ $t("common.btn.create") }}
      </VBtn>
    </div>
        ...
        <template #item.actions="{ item }">
          <div class="d-flex justify-space-between">
            <VIcon
              ...
              class="details_icon"
              @click="
                $router.push(`/form/government-personnel-expense/${item.id}`)
              "
            />
            <VIcon
              :icon="'tabler-edit'"
              ...
              @click="
                $router.push(
                  `/form/government-personnel-expense/${item.id}/edit`,
                )
              "
            />
...
const { t: $t } = useI18n();
const api = useExpenseBudgetDraftApi();
